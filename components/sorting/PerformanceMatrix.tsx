...
interface PerformanceMatrixProps {
    ...
    algoName: string,
    totalSwaps: number,
    totalComparisions: number
}

const PerformanceMatrix = ({ totalSwaps, totalComparisions, isArraySorted, algoName }: PerformanceMatrixProps) => {
    return (
        <div className='bg-secondary/50 rounded-4xl flex flex-col p-5 shadow-2xl border-2 shadow-secondary gap-3'>
            ...
            <div className='flex flex-col w-full gap-5'>
                ...
                <div className='grid grid-cols-2 gap-3'>
                    <p className='bg-primary/10 rounded-xl text-center text-primary/90 p-5 inline-flex flex-col gap-2 text-md font-bold '>Total Comparisions <span className='font-bold text-xl'>{totalComparisions}</span></p>
                    <p className='bg-primary/10 rounded-xl text-center text-primary/90 p-5 inline-flex flex-col gap-2 text-md font-bold'>Total Swaps <span className='font-bold text-xl'>{totalSwaps}</span></p>
                </div>
            </div>
